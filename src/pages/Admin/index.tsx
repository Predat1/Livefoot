...
export default function AdminDashboard() {
  ...
  const statCards: StatCardProps[] = [
    ...
    },
    {
      ...
      change: `${((stats?.vip_users || 0) / Math.max(stats?.total_users || 1, 1) * 100).toFixed(1)}% du total`,
      changeType: "neutral",
      icon: DollarSign,
      description: "Utilisateurs avec abonnement VIP actif",
      href: "/admin/users",
      color: "bg-amber-500",
    },
    {
      ...
      change: stats?.banned_users && stats.banned_users > 0 ? "Action requise" : "Aucun",
      changeType: stats?.banned_users && stats.banned_users > 0 ? "negative" : "positive",
      icon: Activity,
      description: "Comptes suspendus pour violation",
      href: "/admin/users",
      color: "bg-red-500",
    },
    {
      ...
      change: `${((stats?.active_users_7d || 0) / Math.max(stats?.total_users || 1, 1) * 100).toFixed(1)}% engagement`,
      changeType: "positive",
      icon: Zap,
