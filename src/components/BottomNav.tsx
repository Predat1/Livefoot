...
import { Home, Newspaper, Trophy, Star, UserCircle } from "lucide-react";
...
const navItems = [
  ...
  { href: "/competitions", icon: Trophy, label: "Cups" },
        ...
        {navItems.map(({ href, icon: Icon, label }) => {
          ...
          return (
            ...
            >
              ...
              <span className={cn("text-[10px] font-medium leading-none", active ? "text-primary" : "text-header-foreground/50")}>
                {label}
              </span>
              {active && (
